  ...
  return (
    <>
      <header className="pt-[5rem]">
        <div className="w-full bg-slate-300 dark:bg-cont-100 p-4 md:p-6 lg:p-12 xl:h-[950px]">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 pt-10 place-content-center">
            <div className="grid place-content-center p-10 gap-y-3 lg:mx-24 xl:h-[500px]">
              <div className="text-5xl font-semibold text-left">
                ...
                <p className="py-3 dark:text-white text-base font-normal text-justify">
              ...
              <div className="flex flex-col gap-2 w-full">
                <Link href='/contacto'>
                <Button className='dark:bg-btn-400 dark:hover:bg-btn-600 bg-btn-200 hover:bg-btn-400 transition-colors duration-300 flex items-center gap-3 w-full place-content-center text-white' >
                  <FaEnvelope/>
                  Contacto
                </Button>
                </Link>
