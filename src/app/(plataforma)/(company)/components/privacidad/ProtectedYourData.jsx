    ...
    <>
        ...
        <div className="max-w-7xl mx-5 md:mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-2">
            <div className="px-5 py-14">
              ...
              <button type="button" className="flex items-center gap-2 justify-center mx-auto text-link-100 hover:text-link-300 duration-150 transition-colors">
      ...
      <section className="py-5 bg-cont-100">
        <div className=" flex flex-col justify-center items-center mx-5 md:mx-auto">
          ...
          <div className="flex flex-col justify-center items-center md:mx-auto space-y-3 my-3 rounded-xl p-5 md:p-10 bg-nav-900 md:w-[710px] lg:w-[1280px] shadow-lg shadow-cyan-950 ">
            ...
            <button type="button" className="flex items-center gap-2 text-link-100 hover:text-link-300 duration-150 transition-colors">
              Consutar documento
              <FaAngleRight/>
            </button>
          </div>
