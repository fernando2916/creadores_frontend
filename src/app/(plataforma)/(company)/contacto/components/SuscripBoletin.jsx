        ...
        <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 lg:max-w-none lg:grid-cols-2">
          <div className="max-w-xl lg:max-w-lg">
            ...
            <div className="mt-6 flex flex-col md:flex-row space-y-3 max-w-md gap-x-4">
              ...
              <input
                ...
                autoComplete="email"
                required
                className="min-w-0 flex-auto rounded-md border-2 outline-none border-link-300 bg-transparent px-3.5 py-2 shadow-sm sm:text-sm sm:leading-6 placeholder:text-black placeholder:font-semibold dark:placeholder:font-semibold dark:placeholder:text-gray-400"
                placeholder="Ingresa tu Correo Electrónico"
              />
              <button
                type="submit"
                className="flex items-center mx-auto w-full md:w-1/3 justify-center gap-2 rounded-md px-3.5 py-2.5 font-semibold bg-btn-200 hover:bg-btn-400 text-white dark:bg-btn-400 dark:hover:bg-btn-600 transition-colors duration-150 "
                  >
          ...
          <dl className="grid grid-cols-1 gap-x-8 gap-y-10 sm:grid-cols-2 lg:pt-2">
            <div className="flex flex-col items-start">
              <div className="rounded-md bg-btn-200 text-white dark:bg-btn-400 p-2 ring-link-500">
                <FaCalendar className="h-6 w-6 " aria-hidden="true" />
              </div>
              <dt className="mt-4 font-semibold text-xl ">Artículos Mensuales </dt>
              <dd className="mt-2 leading-7 text-slate-500 text-justify">
