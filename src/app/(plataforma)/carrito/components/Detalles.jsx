import { FaCheck, FaClock, FaQuestion, FaTimes } from "react-icons/fa"
  ...
  return (
    <div className="">
      <div className="max-w-2xl mx-auto pt-16 pb-24 px-4 sm:px-6 lg:max-w-7xl lg:px-8">
        <h1 className="text-3xl font-extrabold tracking-tight sm:text-4xl">Detalles del carrito</h1>
                  ...
                  <div className="ml-4 flex-1 flex flex-col justify-between sm:ml-6">
                    ...
                    <p className="mt-4 flex text-sm text-gray-700 space-x-2">
                      {product.inStock ? (
                        ...
                        <FaClock className="flex-shrink-0 h-5 w-5 text-gray-300" aria-hidden="true" />
                      )}
            ...
            <dl className="mt-6 space-y-4">
              ...
              <div className="border-t border-gray-200 pt-4 flex items-center justify-between">
                <dt className="flex items-center text-sm">
                  ...
                  <a href="#" className="ml-2 flex-shrink-0  hover:text-gray-500">
